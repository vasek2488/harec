...
- Browser launcher: `/home/vislousv/SyncThing/70_AI/tools/ai-browser start`
- Browser policy: Lightpanda first, Chrome fallback through the shared launcher
- Chrome-only exceptions: none by default
- Auth or setup notes: none
