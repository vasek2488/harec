...
describe('exam-engine', () => {
  ...
  describe('calculateScore', () => {
    ...
    it('should calculate score and pass status', () => {
      ...
      const result = calculateScore(answers, makeRules(3));
    ...
    it('should handle empty answers', () => {
      ...
      expect(result.total).toBe(examConfig.examRules.totalQuestions);
    ...
    it('should count unanswered questions as incorrect', () => {
      ...
      const result = calculateScore(answers, makeRules(4));
